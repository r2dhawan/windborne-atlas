...
// Dynamic imports for SSR-safe Leaflet (use `any` to bypass TS errors)
...
const Popup: any = dynamic(() => import("react-leaflet").then((m) => m.Popup), {
  ssr: false,
});
    ...
    <div className="min-h-screen">
      <header className="p-4 bg-slate-900 text-white">
        <h1 className="text-2xl">
          WindBorne Atlas — Live Constellation - Rudraksh Dhawan - University of
          Waterloo
        </h1>
        <p className="text-sm opacity-80">
          Animating one hour at a time. Each hour highlighted with a bright
          color. Some data may fluctuate due to corrupted API versions.
        </p>
      </header>
